...
public class remove_content{
	...
	public void run_remove_content( Integer c, Integer u1, Integer u2){
		if(guard_remove_content(c,u1,u2)) {
			...
			machine.set_owner(chatcontent_tmp.restrictDomainTo(new BRelation<Integer,Integer>(new Pair<Integer,Integer>(c,u1))).rangeSubtraction(new BRelation<Integer,Integer>(new Pair<Integer,Integer>(u1,u2))).domain());
			machine.set_contentorder(contentorder_tmp.restrictDomainTo(chatcontent_tmp.restrictDomainTo(new BRelation<Integer,Integer>(new Pair<Integer,Integer>(c,u1))).rangeSubtraction(new BRelation<Integer,Integer>(new Pair<Integer,Integer>(u1,u2))).domain().domain()));
